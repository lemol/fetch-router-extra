...
export interface Middleware<extra = unknown, method extends RequestMethod | 'ANY' = RequestMethod | 'ANY', params extends Record<string, any> = {}> extends MiddlewareBase<method, params> {
    __extra?: extra;
    (context: RequestContext<method, params>, next: NextFunction): Response | undefined | void | Promise<Response | undefined | void>;
}
declare class ParentMiddleware<middlewares extends Middleware[]> {
    constructor(_parent: middlewares);
}
type ExtractExtraFromParentMiddleware<Parent extends ParentMiddleware<any>> = Parent extends ParentMiddleware<infer middlewares> ? ExtractExtra<middlewares> : never;
/**
 ...
 * ```
 */
export declare function use<M extends Middleware[], Parent extends ParentMiddleware<any>>(parent: Parent, middleware: M): Middleware<ExtractExtraFromParentMiddleware<Parent> & ExtractExtra<M>>[];
export declare function use<M extends Middleware[]>(middleware: M): M;
/**
 ...
 * ```
 */
export declare function withParent<M extends Middleware[]>(): ParentMiddleware<M>;
export {};
