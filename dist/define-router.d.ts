 ...
 * ```
 */
export declare function defineAction<const M extends readonly Middleware[], route extends string | RoutePattern | Route>(route: route, options: {
    middleware: M;
    action: (context: RequestContext<GetMethod<route>, GetParams<route>> & {
 ...
 * ```
 */
export declare function defineAction<const M extends readonly Middleware[], method extends RequestMethod | 'ANY' = RequestMethod | 'ANY', pattern extends string = string>(options: {
    middleware: M;
    action: (context: RequestContext<method, Params<pattern>> & {
        extra: ExtractExtra<M>;
    }) => Response | Promise<Response>;
